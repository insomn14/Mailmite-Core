 ...
 * fetch the file via getFile + file_path, POST it to Malimite API
 * (MALIMITE_API_URL), reply with scan_id.
 *
 * Env:
 *   TELEGRAM_BOT_TOKEN
 *   MALIMITE_API_URL    e.g. http://api:8080
...
public class TelegramBot {
    ...
    public static void main(String[] args) throws Exception {
        run(require("TELEGRAM_BOT_TOKEN"), require("MALIMITE_API_URL"), System.getenv("MALIMITE_API_KEY"));
    }

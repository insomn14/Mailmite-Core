 ...
 *
 * Required for all: MAILMITE_API_URL
 * Optional for all: MAILMITE_API_KEY
 */
public class BotLauncher {
    ...
    public static void main(String[] args) throws InterruptedException {
        String apiUrl = System.getenv("MAILMITE_API_URL");
        if (apiUrl == null || apiUrl.isBlank())
            throw new IllegalStateException("MAILMITE_API_URL is required");
        String apiKey = System.getenv("MAILMITE_API_KEY");

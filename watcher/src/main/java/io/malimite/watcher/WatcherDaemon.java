package io.malimite.watcher;

import io.malimite.core.AnalyzeOptions;
import io.malimite.core.MalimiteAnalyzer;
...
public class WatcherDaemon {
    ...
    public static void main(String[] args) throws Exception {
        Path incoming = Path.of(env("INCOMING_DIR", "/var/malimite/incoming"));
        Path reports  = Path.of(env("REPORT_DIR",   "/var/malimite/reports"));
    ...
    private static void handle(MalimiteAnalyzer a, Path pkg, Path ghidra, Path jadx, Path reports) {
        try {
            waitStable(pkg);
